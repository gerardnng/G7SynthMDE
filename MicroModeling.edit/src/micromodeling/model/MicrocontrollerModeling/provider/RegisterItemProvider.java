...
/**
 * This is the item provider adapter for a {@link micromodeling.model.MicrocontrollerModeling.Register} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegisterItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Register_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Register_name_feature", "_UI_Register_type"),
				 MicrocontrollerModelingPackage.Literals.REGISTER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Register_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Register_type_feature", "_UI_Register_type"),
				 MicrocontrollerModelingPackage.Literals.REGISTER__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Register.class)) {
			case MicrocontrollerModelingPackage.REGISTER__NAME:
			case MicrocontrollerModelingPackage.REGISTER__TYPE:
