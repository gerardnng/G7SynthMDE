...
/**
 * This is the item provider adapter for a {@link micromodeling.model.MicrocontrollerModeling.Pin} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PinItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MicrocontrollerModelingPackage.Literals.PIN__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MicrocontrollerModelingPackage.Literals.PIN__NUMBER,
				 true,
				 false,
				 false,
	...
	protected void addNaturePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pin_nature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pin_nature_feature", "_UI_Pin_type"),
				 MicrocontrollerModelingPackage.Literals.PIN__NATURE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Pin.class)) {
			case MicrocontrollerModelingPackage.PIN__NAME:
			case MicrocontrollerModelingPackage.PIN__NATURE:
			case MicrocontrollerModelingPackage.PIN__NUMBER:
