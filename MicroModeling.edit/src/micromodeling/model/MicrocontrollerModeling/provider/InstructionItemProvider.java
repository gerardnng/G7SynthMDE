...
/**
 * This is the item provider adapter for a {@link micromodeling.model.MicrocontrollerModeling.Instruction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InstructionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Instruction_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Instruction_value_feature", "_UI_Instruction_type"),
				 MicrocontrollerModelingPackage.Literals.INSTRUCTION__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Instruction)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Instruction.class)) {
			case MicrocontrollerModelingPackage.INSTRUCTION__VALUE:
