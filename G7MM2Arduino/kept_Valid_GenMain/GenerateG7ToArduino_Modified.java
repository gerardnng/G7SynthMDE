...
/**
 * Entry point of the 'GenerateG7ToArduino' generation module.
 *
 * @generated
 */
public class GenerateG7ToArduino extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/G7MM2Arduino/main/generateG7ToArduino";
    ...
    /** The second model on which to iterate for this generation (Microcontroller model). */
	protected EObject micro_model;
     ...
     * @generated
     */
    public GenerateG7ToArduino(URI modelURI, File targetFolder,
     ...
     * 
     * @param g7_modelURI
     *            URI where the Grafcet model on which this generator will be used is located.
     * @param micro_modelURI
     *            URI where the Microcontroller model on which this generator will be used is located.
     * @param targetFolder
     *            This will be used as the output folder for this generation : it will be the base path
     *            against which all file block URLs will be resolved.
     * @param arguments
     ...
     * @generated NOT
     */
    public GenerateG7ToArduino(URI g7_modelURI, URI micro_modelURI,File targetFolder,
            List<? extends Object> arguments) throws IOException {
        //initialize(g7_modelURI, targetFolder, arguments);
    	initialize(g7_modelURI, micro_modelURI, targetFolder, arguments);
    }
    
    //@Override
    public void initialize(URI g7_modelURI, URI micro_modelURI, File folder, List<?> arguments) throws IOException {
		...
		URI grafcet_newModelURI = URI.createURI(g7_modelURI.toString(), true);
		URI micro_newModelURI = URI.createURI(micro_modelURI.toString(), true);
		
		model = ModelUtils.load(grafcet_newModelURI, modelResourceSet);
		micro_model = ModelUtils.load(micro_newModelURI, modelResourceSet);
     ...
     * @generated
     */
    public GenerateG7ToArduino(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            /*if (args.length < 2) {
            	...
            	String g7_model_URI_path = "E:/workspace/GrafcetModeling/runtime-GrafcetConfigForTests/GrafcetInstancesProject/Eval_Efficiency3_modified.grafcetmodeling";
            	String micro_model_URI_path = "E:/workspace/GrafcetModeling/runtime-GrafcetConfigForTests/GrafcetInstancesProject/Eval_Efficiency3_modified.grafcetmodeling";
            	
            	String folder_path = "E:/workspace/G7MM2Arduino/arduinoCodes";
            	
            	
                URI g7_modelURI = URI.createFileURI(g7_model_URI_path);
                URI micro_modelURI = URI.createFileURI(micro_model_URI_path);
                
                File folder = new File(folder_path);
                
                System.out.println("MAIN JAVA. modelURI path = "+args[0] + "\nFolder path = "+args[1]+"\n\n");
                ...
                GenerateG7ToArduino generator = new GenerateG7ToArduino(g7_modelURI, micro_modelURI, folder, arguments);
    ...
    public Map<String, String> generate(Monitor monitor, boolean recursive) throws IOException {
		...
		AcceleoService service2 = createAcceleoService();
		...
		service2.doPrepareGeneration(monitor, target);
		...
		for (int i = 0; i < templateNames.length; i++) {
			result.putAll(service.doGenerate(getModule(), templateNames[i], micro_model, recursive,
					getArguments(), target, monitor));
		}
		...
		System.out.println("\n END: service.finalizeGeneration()");
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        //NNG
        resourceSet.getPackageRegistry().put("/GrafcetModeling/model/grafcetModeling.ecore", GrafcetModelingPackage.eINSTANCE);
        
        //NNG2
        resourceSet.getPackageRegistry().put("/MicroModeling/model/MicrocontrollerModeling.ecore", MicrocontrollerModelingPackage.eINSTANCE);
    ...
    public void registerResourceFactories(ResourceSet resourceSet) {
        ...
        //NNG
        resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put("grafcetmodeling", new XMIResourceFactoryImpl());
        resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put("xmi", new XMIResourceFactoryImpl());
        
        //NNG2
        resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put("microcontrollermodeling", new XMIResourceFactoryImpl());
