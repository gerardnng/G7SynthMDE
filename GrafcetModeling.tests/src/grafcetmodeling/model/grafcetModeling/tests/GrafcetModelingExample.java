...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>grafcetModeling</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class GrafcetModelingExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(GrafcetModelingPackage.eNS_URI, 
			 GrafcetModelingPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.grafcetmodeling")); //$NON-NLS-1$
				Grafcet root = GrafcetModelingFactory.eINSTANCE.createGrafcet();
